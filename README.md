...
When you cursor is not in any cell, no cell is active. When your cursor leave a cell, its output
window will close.
...
| `MoltenImportOutput`      | `[path]`              | Import outputs from a jupyter notebook (`.ipynb`). [read more](./docs/Advanced-Functionality.md) |
