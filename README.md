...
| `g:molten_use_border_highlights`              | (`false`) \| `true`                                         | When true, uses different highlights for output border depending on the state of the cell (running, done, error). see [highlights](#highlights) |
